...
declare_text_keys!(
    ...
    PreviewGrid,
    PreviewMaterials,
    PreviewMaterialsMissing,
    PreviewMaterialsNone,
    PreviewVertices,
    PreviewDisplayedTriangles,
    PreviewDimensions,
    Meshes,
    Triangles,
    Actions,
...
fn chinese(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::SwitchToLight => "切换到亮色",
        TextKey::SwitchToDark => "切换到暗色",
        ...
        TextKey::Meshes => "网格",
        TextKey::PreviewViewport => "视图",
        TextKey::PreviewInfo => "模型信息",
        TextKey::PreviewName => "名称",
        TextKey::PreviewFile => "文件",
        TextKey::PreviewGrid => "地面网格（G）",
        TextKey::PreviewMaterials => "材质",
        TextKey::PreviewMaterialsMissing => "部分贴图缺失",
        TextKey::PreviewMaterialsNone => "该模型没有贴图路径",
        TextKey::PreviewVertices => "顶点",
        TextKey::PreviewDisplayedTriangles => "显示三角形",
        TextKey::PreviewDimensions => "尺寸",
...
fn english(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::SwitchToLight => "Switch to light",
        TextKey::SwitchToDark => "Switch to dark",
        ...
        TextKey::OpenPreview => "Open model preview…",
        ...
        TextKey::PreviewViewport => "Viewport",
        TextKey::PreviewInfo => "Model info",
        TextKey::PreviewName => "Name",
        TextKey::PreviewFile => "File",
        TextKey::PreviewGrid => "Ground grid (G)",
        TextKey::PreviewMaterials => "Materials",
        TextKey::PreviewMaterialsMissing => "Missing textures",
        TextKey::PreviewMaterialsNone => "No texture paths in this model",
        TextKey::PreviewVertices => "Vertices",
        TextKey::PreviewDisplayedTriangles => "Displayed triangles",
        TextKey::PreviewDimensions => "Dimensions",
...
fn french(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::SwitchToLight => "Passer au thème clair",
        TextKey::SwitchToDark => "Passer au thème sombre",
        ...
        TextKey::OpenPreview => "Ouvrir un aperçu du modèle…",
        ...
        TextKey::PreviewViewport => "Vue",
        TextKey::PreviewInfo => "Informations",
        TextKey::PreviewName => "Nom",
        TextKey::PreviewFile => "Fichier",
        TextKey::PreviewGrid => "Grille au sol (G)",
        TextKey::PreviewMaterials => "Matériaux",
        TextKey::PreviewMaterialsMissing => "Textures manquantes",
        TextKey::PreviewMaterialsNone => "Aucun chemin de texture dans ce modèle",
        TextKey::PreviewVertices => "Sommets",
        TextKey::PreviewDisplayedTriangles => "Triangles affichés",
        TextKey::PreviewDimensions => "Dimensions",
        TextKey::Triangles => "triangles",
        TextKey::Actions => "Actions",
        TextKey::MiSansMissing => {
...
fn russian(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::SwitchToLight => "Включить светлую тему",
        TextKey::SwitchToDark => "Включить тёмную тему",
        ...
        TextKey::OpenPreview => "Открыть предпросмотр модели…",
        ...
        TextKey::PreviewViewport => "Вид",
        TextKey::PreviewInfo => "Информация",
        TextKey::PreviewName => "Имя",
        TextKey::PreviewFile => "Файл",
        TextKey::PreviewGrid => "Сетка основания (G)",
        TextKey::PreviewMaterials => "Материалы",
        TextKey::PreviewMaterialsMissing => "Отсутствуют текстуры",
        TextKey::PreviewMaterialsNone => "В модели нет путей к текстурам",
        TextKey::PreviewVertices => "Вершины",
        TextKey::PreviewDisplayedTriangles => "Показанные треугольники",
        TextKey::PreviewDimensions => "Размеры",
...
fn spanish(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::SwitchToLight => "Cambiar a tema claro",
        TextKey::SwitchToDark => "Cambiar a tema oscuro",
        ...
        TextKey::OpenPreview => "Abrir vista previa del modelo…",
        ...
        TextKey::PreviewViewport => "Vista",
        TextKey::PreviewInfo => "Información",
        TextKey::PreviewName => "Nombre",
        TextKey::PreviewFile => "Archivo",
        TextKey::PreviewGrid => "Cuadrícula del suelo (G)",
        TextKey::PreviewMaterials => "Materiales",
        TextKey::PreviewMaterialsMissing => "Texturas faltantes",
        TextKey::PreviewMaterialsNone => "El modelo no tiene rutas de texturas",
        TextKey::PreviewVertices => "Vértices",
        TextKey::PreviewDisplayedTriangles => "Triángulos mostrados",
        TextKey::PreviewDimensions => "Dimensiones",
